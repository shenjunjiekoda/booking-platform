  ...
  <div>
    <el-table
        ...
        <el-table-column label="" v-if="!tableStyle">
          <template slot-scope="scope">
            <div>
              ...
              <div style="text-align:right;margin:5px;margin-right:30px;font-size:17px">
                {{ scope.row.from }}
              </div>
              <div style="color: rgba(0, 0, 0, 0.45);font-size:16px;line-height: 22px;margin: 5px;text-align:right">
                {{scope.row.createdat}}
              </div>
              <div v-if="scope.row.readed===0" style="text-align:right;margin-right:25px">
                <el-button size="mini" @click="setReaded(scope.row)">
                  标为已读
                </el-button>
              </div>
            </div>
      ...
      <div v-if="tableStyle">
        ...
        <el-table-column label="来自" align="center">
          <template slot-scope="scope">
            {{ scope.row.from }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="时间" prop="executeAt" align="center" sortable>
          <template slot-scope="scope">
            {{scope.row.createdat}}
          </template>
        </el-table-column>
