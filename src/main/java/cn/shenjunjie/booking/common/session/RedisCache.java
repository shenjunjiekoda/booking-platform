...
import cn.shenjunjie.booking.common.exception.CacheManagerPrincipalIdNotAssignedException;
import cn.shenjunjie.booking.common.exception.PrincipalIdNullException;
import cn.shenjunjie.booking.common.exception.PrincipalInstanceException;
import cn.shenjunjie.booking.common.exception.SerializationException;
import cn.shenjunjie.booking.common.session.serializer.ObjectSerializer;
import cn.shenjunjie.booking.common.session.serializer.RedisSerializer;
import cn.shenjunjie.booking.common.session.serializer.StringSerializer;
...
public class RedisCache<K, V> implements Cache<K, V> {
    ...
    public V get(K key) throws CacheException {
        ...
        try {
            ...
            return value;
        } catch (SerializationException | CacheManagerPrincipalIdNotAssignedException e) {
    ...
    private Object getRedisCacheKey(K key) throws CacheManagerPrincipalIdNotAssignedException {
        if (key == null) {
            return null;
        }
    ...
    private String getStringRedisKey(K key) throws CacheManagerPrincipalIdNotAssignedException {
        String redisKey;
    ...
    private String getRedisKeyFromPrincipalIdField(PrincipalCollection key) throws CacheManagerPrincipalIdNotAssignedException {
    ...
    private Method getPrincipalIdGetter(Object principalObject) throws CacheManagerPrincipalIdNotAssignedException {
    ...
    private String getPrincipalIdMethodName() throws CacheManagerPrincipalIdNotAssignedException {
